...
@TeleOp(name = "teleopfull-cleaned")
public class TeleOpFullCleaned extends OpMode {
    ...
    public void loop() {
        ...
        if(gamepad1.right_trigger < 0.5) telemetry.addData("Speed Mode", "off");
        else
        {
        ...
        if (!isAutoAiming) {
            ...
            telemetry.addData("facingTarget", facingTarget);
        }
