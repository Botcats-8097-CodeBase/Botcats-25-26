...
public class OctoLocalizer implements Localizer {
    ...
    public void setStartPose(Pose setStart) {
        octoQuad.setLocalizerPose((int) (setStart.getX() * DistanceUnit.mmPerInch), (int) (setStart.getY() * DistanceUnit.mmPerInch), (float) setStart.getHeading());
    }

    @Override
    public void setPose(Pose setPose) {
        octoQuad.setLocalizerPose((int) (setPose.getX() * DistanceUnit.mmPerInch), (int) (setPose.getY() * DistanceUnit.mmPerInch), (float) setPose.getHeading());
    }
    ...
    public void update() {
        ...
        if (localizer.crcOk) {
            ...
            currPose = new Pose(localizer.posX_mm / DistanceUnit.mmPerInch, localizer.posY_mm / DistanceUnit.mmPerInch, localizer.heading_rad);
            currVel = new Pose(localizer.velX_mmS / DistanceUnit.mmPerInch, localizer.velY_mmS / DistanceUnit.mmPerInch);
