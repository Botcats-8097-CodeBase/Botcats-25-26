...
public class VelocityMotor2 {
    ...
    NoiseFilter velocityFilter = new NoiseFilter(0.7, 5);
    ...
    public void update() {
        ...
        velocityFilter.update((lastPos-motor.getCurrentPosition()) / dt);
        ...
        if (!velocityFilter.isDataless() && !accelerationFilter.isDataless()) {
